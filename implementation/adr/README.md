...
Esta carpeta contiene los Architecture Decision Records (ADR) de implementación del sistema.
...
Ejemplos de decisiones que **no** corresponden aquí sino en `design/adr/`:

- qué algoritmo de derivación de claves usa el sistema
- qué mecanismo de autenticación ofrece la plataforma al ciudadano
