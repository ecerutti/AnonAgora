...
## Antes de iniciar el desarrollo de la demo con Claude Code
...
- **Backups y logs.** Recordar incluir en la guía una sección sobre el manejo de logs en backups: los logs no deben incluirse dentro de los backups, o debe realizarse un borrado previo de los logs antes del backup.
