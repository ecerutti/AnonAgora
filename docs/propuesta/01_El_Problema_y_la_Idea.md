...
Desde ese momento, dentro del edificio todos te ven solo como ese número. Nadie allí sabe quién sos realmente, pero el sistema puede reconocer que sos el mismo participante cada vez que volvés.
...
- qué temas empiezan a preocupar a la ciudadanía
- qué propuestas generan apoyo significativo
- cómo evolucionan las opiniones con el tiempo
...
- Un grupo de ciudadanos propone mejorar un sistema de transporte público.
- Con el tiempo, miles de personas comienzan a apoyar esa iniciativa.  
- Otras propuestas similares aparecen con variantes o mejoras.
- Gradualmente empieza a hacerse visible que existe una preocupación compartida dentro de la sociedad.
